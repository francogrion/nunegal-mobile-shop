// Raw responses captured from the real API (https://itx-frontend-test.onrender.com).
// They keep the API quirks on purpose (typos, swapped fields, empty prices...)
// so tests exercise the same data the app receives in production.
